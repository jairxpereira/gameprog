// prj_Teclado02 - Arquivo: Tela.cs
// Esse projeto mostra como usar o teclado via DirectInput
// Exemplo 02 - Produzido por www.gameprog.com.br
using System;
...
namespace prj_Teclado02
{
  ...
  public partial class Tela : Form
  {
    ...
    void verificarTeclado()
    {
      ...
      if (estadoTeclado[DirectInput.Key.DownArrow] ) seta_abaixo = 1;
      if (estadoTeclado[DirectInput.Key.UpArrow]   ) seta_cima = 1;
      if (estadoTeclado[DirectInput.Key.LeftArrow] ) seta_esquerda = 1;
      if (estadoTeclado[DirectInput.Key.RightArrow]) seta_direita = 1;
      if (estadoTeclado[DirectInput.Key.RightShift]) xcol = 320;
      if (estadoTeclado[DirectInput.Key.RightShift]) ylin = 240;
      if (estadoTeclado[DirectInput.Key.Escape]) terminar = true;
