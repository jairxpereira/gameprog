...
// O método Create() carrega uma parte do arquivo wav no buffer
// e enquanto o som vai tocando mais partes são gravadas no buffer
// pela função HandleWaveStreamNotification() sempre que o evento
// hNotifyEvent é disparado.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// classe CWaveFile
// Empacota leitura e gravação de dados de som de ou para 
// o arquivo wav
//-----------------------------------------------------------------------------
class CWaveFile
{
