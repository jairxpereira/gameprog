...
// manipular a alocação de memória. Naturalmente que  isso  foi  definido
// na classe CMeshHierarchy
...
void CModelo::SetupBoneMatrices( OSSO *pFrame, D3DXMATRIX *pParentMatrix)
{
	...
	if ( pMesh )
	{
		...
		{			
			...
			// Devevemos trabalhar a matriz de cada osso individualmente
...
{	
	// Desenhe todos os mesh containers neste frame
