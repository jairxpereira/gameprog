//-----------------------------------------------------------------------------
// Projeto: prj_Cubo - Arquivo: motor.h
...
// ------------------------------------------------------------------------
// Renderiza o quadrado lateral que representa uma lua orbitando
...
{
    MessageBoxW( NULL,
                L"Falha na compilação do arquivo prj_Cubo.fx", 
...
// endfile: motor.cpp﻿// -----------------------------------------------------------------------------
// Projeto: prj_Cubo - Arquivo: entrada.cpp
// Exemplo de como renderizar um cubo colorido (directx 11)
// Produzido por www.gameprog.com.br
// -----------------------------------------------------------------------------
#include <windows.h>
