...
// Name é o nome do frame
// retNewFrame - é o ponteiro de retorno aonde assinalamos o frame
// recém-criado.
...
{    
	...
	*_outNewMeshPack = 0;
	...
	// Criação da array de texturas e materiais. Perceba que que eu quero ter ao
	// menos um
