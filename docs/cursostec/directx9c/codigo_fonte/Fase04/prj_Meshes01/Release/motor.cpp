...
LPDIRECT3DTEXTURE9* g_meshTex = NULL;
...
HRESULT initGfx( HWND hJanela )
{
	...
	CarregarModelo("C:\\gameprog\\gdkmedia\\Modelos\\Tiny\\", "tiny.x");
...
void CarregarModelo( char *diretorioBase, char *arquivo)
{
	...
	g_meshTex  = new LPDIRECT3DTEXTURE9[g_mtlQtd];
