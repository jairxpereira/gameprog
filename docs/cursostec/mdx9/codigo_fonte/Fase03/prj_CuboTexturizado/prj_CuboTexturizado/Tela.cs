...
namespace prj_CuboTexturizado
{
  public partial class Tela : Form
  {
    ...
    public void initGfx()
    {
      ...
      8, device, Usage.Dynamic | Usage.WriteOnly,
    ...
    private void AtualizarCamera()
    {
      ...
      device.Transform.World = Matrix.RotationX(angulo) * Matrix.RotationY(angulo);  
    ...
    public void montar_triangulos()
    {
      ...
      // É necessário apenas 4 vértices para compor o quadrado utilizando
      // o buffer de índices
      triangulo = new CustomVertex.PositionTextured[8];
      ...
      // p4, p5, p6, p7
      zpos--; // Mande a face para atrás
      triangulo[4] = new CustomVertex.PositionTextured(1.0f, 1.0f, zpos, 0.0f, 0.0f);
      triangulo[5] = new CustomVertex.PositionTextured(-1.0f, 1.0f, zpos, 1.0f, 0.0f);
      triangulo[6] = new CustomVertex.PositionTextured(-1.0f, -1.0f, zpos, 1.0f, 1.0f);
      triangulo[7] = new CustomVertex.PositionTextured(1.0f, -1.0f, zpos, 0.0f, 1.0f);
